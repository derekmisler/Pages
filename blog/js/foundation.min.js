...
$(document).ready(function() {
  ...
  function setCellHeights(original, copy) {
	...
	$('span[style*="font-family"]').each(function() {
			$(this).css('font-family','');
	});
		
	$('div[style*="Trebuchet"]').each(function() {
			$(this).css('font-family','');
	});
		
	$('div[style*="justify"]').each(function() {
			$(this).removeAttr('style');
	});
	
	$('span[style*="large"]').each(function() {
			$(this).removeAttr('style').addClass('override');
	});
		
	$('span[style*="fce5cd"]').each(function() {
			$(this).removeAttr('style');
	});
	...
	$('div[class*="separator"]').each(function() {
			$(this).removeAttr('style').addClass('clear').removeClass('separator');
	});
		
	$('table[class*="tr-caption-container"]').each(function() {
			$(this).addClass('panel');
	});
		
	$('table[class*="tr-caption-container"] tbody tr td a img').each(function() {
			$(this).removeAttr('border').removeAttr('width');
	});
		
	$('a img:not(.thumbnail)').each(function() {
			$(this).removeAttr('border').removeAttr('width');
	});
		
	$('table[style*="float: right; text-align: right;"]').each(function() {
			$(this).css('float','right').css('margin-left','1em');
	});
		
	$('table[style*="float: left; text-align: left;"]').each(function() {
			$(this).css('float','left').css('margin-right','1em');
	});
		
	$('a[style*="margin-center"]').each(function() {
			$(this).css({
				"text-align":"center",
				"display":"block"
			});
	...
	window.onscroll = function()
	{
		if( window.XMLHttpRequest ) {
			if (document.documentElement.scrollTop > 99 || self.pageYOffset > 99) {
				$('.social').css('position','fixed');
				$('.wrapper').css('padding-top','20px');
				$('.social').css('top','0');
			} else if (document.documentElement.scrollTop < 99 || self.pageYOffset < 99) {
